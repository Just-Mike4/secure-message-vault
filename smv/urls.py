"""
URL configuration for smv project.
...
from users.views import (LoginView, PasswordResetView,
                        RegistrationView,PasswordResetConfirmView)
from messagesvault.views import MessageViewSet
